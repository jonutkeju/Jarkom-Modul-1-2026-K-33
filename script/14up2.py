# Script Decode USB HID Keystroke
conv_table = {
    ...
    0x2E:'=', 0x2F:'[', 0x30:']', 0x31:'\\', 0x33:';', 0x34:'\'', 0x36:',', 0x37:'.', 0x38:'/'
}
...
with open("hex.txt", "r") as f:
    for line in f:
        ...
        if is_shift and keycode in conv_table_shift:
            result.append(conv_table_shift[keycode])
        elif not is_shift and keycode in conv_table:
            result.append(conv_table[keycode])

print("\n=== HASIL DECODE KE YBOARD ===")
print("".join(result))
